...
const removeStudent = (studentId, callback) => {
  console.log("Student id sent to delete: "+ studentId);
    ...
    render: (text, student) =>
      <Radio.Group>
        <Popconfirm
          ...
          //fetch student to update the table after deleting the student
    ...
    return <>
     ...
     <Table dataSource={students}
                  ...
                  title={()=> <>
                    ...
                    <br/><br/>
                    <Button onClick={()=> setShowDrawer(!showDrawer)} type="primary" shape="round" icon={<PlusOutlined/>} size="small"> Add New Student</Button>
                  </>
     }
