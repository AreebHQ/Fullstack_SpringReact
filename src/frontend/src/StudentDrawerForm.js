...
function StudentDrawerForm({showDrawer, setShowDrawer,fetchStudents}) {
  ...
  const onFinish = student => {
    ...
    //add student details from student object
    //if all good - log student added , if there is an error log error
    addNewStudent(student).then(() => {
      console.log("student added")
      //close drawer and fetch all students again
      onCLose();
      ...
      //once process is done, hide the spinning icon
      setsubmitting(false);
    });
  }
